...
export default function ScrollToolbar(props) {
  ...
  const icons = {
    'delete': <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-x" viewBox="0 0 16 16">
    ...
    'add': <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-plus" viewBox="0 0 16 16">
        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
      </svg>,
    'save': saved ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bookmark-fill" viewBox="0 0 16 16">
  ...
  const toolbar = <h6 className="toolbar">
    {
      props.scroll ? (
        // created scroll view...
        <>
          <Link className="link-dark text-decoration-none faded toolbar-btn" to={`/users/${props.scroll.createdBy.username}`}>
